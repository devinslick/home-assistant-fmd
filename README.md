...
- 🔄 **Improved polling logic**: Device tracker now actively requests fresh location data from the device during every poll (instead of just fetching server cache), ensuring more up-to-date tracking.
